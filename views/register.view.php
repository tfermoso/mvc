...
<body>
    ...
    <form action="./register/form" method="post" class="login-form">
        <label for="user" class="form-label">Username</label>
        <input type="text" name="user" id="" class="form-input" required placeholder="Username" autofocus>
        <label for="email" class="form-label">Email</label>
        <input type="email" name="email" id="" class="form-input" required placeholder="Email">
        ...
        <input type="password" name="c_password" id="" class="form-input" required placeholder="Repeat password">
